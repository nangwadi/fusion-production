...
function add_module_category(){
    ...
    $.ajax({
        url: base_url+'distribution/add-module-category/'+key_session,
        type: 'post',
...
function list_module_category(id_module_category){
    ...
    $.ajax({
        url: base_url+'distribution/list-module-category/'+key_session+'/'+id_module_category,
        type: 'get',
        crossDomain: true,
        dataType: 'JSON',
        success: function(responseGet){
...
function update_module_category(){
    ...
    $.ajax({
        url: base_url+'distribution/update-module-category/'+key_session,
        type: 'post',
