...
function add_employee_permission(){
    var id_employee_permission = $('#id_employee_permission').val();
    ...
    $.ajax({
        url: base_url+'distribution/add-employee-permission/'+key_session,
        type: 'post',
        data: 'id_employee_permission='+id_employee_permission+'&cNmPegawai='+cNmPegawai+'&id_module='+id_module,
        crossDomain: true,
        dataType: 'JSON',
...
function delete_employee(id_employee_permission_get, cNmPegawai_get){
    if (confirm('Are you sure you want to delete '+cNmPegawai_get+' from permission ?')) {
        ...
        $.ajax({
            url: base_url+'distribution/delete-employee-permission/'+key_session,
            type: 'post',
            data: 'id_employee_permission='+id_employee_permission_get,
            crossDomain: true,
            dataType: 'JSON',
            success: function(responseGet){
                //console.log(responseGet);
