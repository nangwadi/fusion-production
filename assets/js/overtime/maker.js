            ...
            responseGet.map(function(responseGetList){
                ...
                if (status==0) {
                    ...
                    response.map(function(responseList, i){
                        ...
                        var action = '<button class="btn btn-info" onclick="update(\''+id_ot_maker+'\', \''+cIDDept+'\', \''+cNmDept+'\', \''+cIDBag+'\', \''+cNmBag+'\',  \''+cNIK+'\', \''+maker_approval+'\');" title="Update overtime maker - '+cNmDept+'."><i class="mdi mdi-lead-pencil"></i></button>&nbsp;&nbsp;';
                        action += '<button class="btn btn-danger" onclick="deleted(\''+id_ot_maker+'\', \''+cNmDept+'\', \''+cNmBag+'\', \''+maker_approval+'\');" title="Delete overtime maker - '+cNmDept+'."><i class="mdi mdi-delete"></i></button>';
...
function getEmployee(cNIK_get, cNmPegawai_get, cIDDept_get, cIDBag_get){
...
function deleted(id_ot_maker_get, cNmDept_get, cNmBag_get, maker_approval){
    if (confirm('Are you sure you want to delete overtime maker department '+cNmDept_get)) {
