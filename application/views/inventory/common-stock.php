		...
		<div class="col-md-12 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<div class="row">
						<div class="col-md-4">
							<h4 class="card-title"><i class="mdi mdi-format-list-bulleted "></i>&nbsp;&nbsp;List Common Stock</h4>
						</div>
						<div class="col-md-8" align="right">
							<h4 class="card-title btn btn-md btn-primary" onclick="add_inventory_form();" id="btn_add"><i class="mdi mdi-plus"></i>&nbsp;&nbsp;Adjust Common Stock</h4>&nbsp;&nbsp;
							<h4 class="card-title btn btn-md btn-info" onclick="modal_take();" id="btn_add"><i class="mdi mdi-cart-plus"></i>&nbsp;&nbsp;Take Common Stock</h4>&nbsp;&nbsp;
							<h4 class="card-title btn btn-md btn-success" onclick="list_stock_out('cs');" id="btn_add"><i class="mdi mdi-logout-variant"></i>&nbsp;&nbsp;List Stock Out</h4>&nbsp;&nbsp;
