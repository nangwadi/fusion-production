		...
		<div class="col-md-12 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<div class="row">
						<div class="col-md-3">
							<h4 class="card-title"><i class="mdi mdi-format-list-bulleted "></i>&nbsp;&nbsp;List Return</h4>
						</div>
					...
					<table class="stripe row-border order-column" id="list_return">
						<thead>
							<tr style="background-color: rgba(129, 129, 129, 1); height:50px;">
								...
								<th style="background-color: rgba(129, 129, 129, 1) !important; z-index: 2;"><center><div style="width: 200px;">Return Number</div></th>
								<th><div style="width: 125px;">Description</div></th>
								<th><div style="width: 75px;" align="center">Qty</div></th>
								<th><div style="width: 100px;" align="center">UOM</div></th>
								<th><div style="width: 150px;" align="right">Unit Price</div></th>
								<th><div style="width: 200px;" align="right">Amount</div></th>
								<th><center><div style="width: 250px;">Order Number</div></center></th>
								<th><center><div style="width: 250px;">Receipt Number</div></center></th>
								<th><div style="width: 125px;" align="center">Create By</div></th>
								<th><div style="width: 125px;" align="center">Date</div></th>
							</tr>
						</thead>
						<!-- <tbody></tbody> -->
					</table>
