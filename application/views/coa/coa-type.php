	...
	<div class="page-header">
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">create new COA Type</li>
			</ol>
		</nav>
	</div>
	<div class="row">
		<div class="col-md-4 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title"><i class="mdi mdi-plus"></i>&nbsp;&nbsp;Add COA Type</h4>
					<hr style="border:2px solid white;">

					<div class="form-group">
						<label>COA Type ID</label>
						<input type="hidden" class="form-control" id="id_coa_type" placeholder="COA Type ID">
						<input type="text" class="form-control" id="coa_type_cd" placeholder="COA Type ID">
					</div>
					<div class="form-group">
						<label>COA Type Name</label>
						<input type="text" class="form-control" id="coa_type_name" placeholder="COA Type Name">
					</div>
		...
		<div class="col-md-8 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title"><i class="mdi mdi-format-list-bulleted "></i>&nbsp;&nbsp;List COA Type</h4>
					<hr style="border:2px solid white;">
					...
					<table class="table table-striped" id="list_coa">
						<thead>
							<tr>
								...
								<th style="color:white;">COA Type ID</th>
	...
	<div class="modal" tabindex="-1" role="dialog" id="modal_disen">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body" style="background-color: white; color: black;">
					<input type="hidden" id="id_coa_type_disen">
