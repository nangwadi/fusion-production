	...
	<div class="page-header">
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">create new Department Approval</li>
			</ol>
		</nav>
	</div>
	<div class="row">
		<div class="col-md-12 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<div onclick="add_approval_show();"><h4 class="card-title"><i class="mdi mdi-plus"></i>&nbsp;&nbsp;Add Department Approval</h4></div>
					<hr style="border:2px solid white;">
					<div id="add_approval" style="display:none;">
						<div class="row">
							<div class="col-md-3">
						...
						<div class="row">
							...
							<div class="col-md-3" style="padding-top:25px;">
								<button class="btn btn-primary me-2" onclick="add_department_approval();"><i class="mdi mdi-content-save"></i>&nbsp;&nbsp;Save</button>
		...
		<div class="col-md-12 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title"><i class="mdi mdi-format-list-bulleted "></i>&nbsp;&nbsp;List Department Approval</h4>
					<hr style="border:2px solid white;">

					<table class="table table-striped" id="list_department_approval">
						<thead>
							<tr>
								...
								<th style="color:white;">Approval 1</th>
								<th style="color:white;">Approval 2</th>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div id="modal_footer_disen">
			        <a class="btn btn-primary" id="btn_disen" onClick="update_department_approval();"></a>
