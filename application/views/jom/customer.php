...
<div class="content-wrapper">
	...
	<div class="row">
		<div class="col-md-4 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title"><i class="mdi mdi-plus"></i>&nbsp;&nbsp;Add Account</h4>
					<hr style="border:2px solid white;">

					<div class="form-group">
						<label>Account ID</label>
						<input type="hidden" class="form-control" id="id_account" placeholder="Account ID">
						<input type="text" class="form-control" id="account_cd" placeholder="Account ID">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label>Account Phone Code</label>
						<input type="number" class="form-control" id="account_phone_code" placeholder="Account Phone Code">
					</div>
		...
		<div class="col-md-8 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title"><i class="mdi mdi-format-list-bulleted "></i>&nbsp;&nbsp;List Account</h4>
					<hr style="border:2px solid white;">
					...
					<table class="table table-striped" id="list_account">
						<thead>
							<tr>
								...
								<th style="color:white;">Account Phone Code</th>
