					...
					<table class="stripe row-border order-column" id="line_description" style="width:100%;">
						<thead>
							<tr style="background-color: rgba(129, 129, 129, 1); height:50px;">
								...
								<th style="background-color: rgba(129, 129, 129, 1) !important; z-index: 2;"><center><div style="width: 200px;">SI / Tax No.</div></th>
								<!-- <th style="background-color: rgba(129, 129, 129, 1) !important; z-index: 2;"><center><div style="width: 200px;">Tax No.</div></th> -->
								<th style="background-color: rgba(129, 129, 129, 1) !important; z-index: 2;"><center><div style="width: 200px;">Cust. Order</div></th>
