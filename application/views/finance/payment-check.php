					...
					<table class="stripe row-border order-column" id="line_description" style="width:100%;">
						<thead>
							<tr style="background-color: rgba(129, 129, 129, 1); height:50px;">
								...
								<th style="background-color: rgba(129, 129, 129, 1) !important; z-index: 2;"><center><div style="width: 200px;">Vendor</div></th>
								...
								<th><center><div style="width: 125px;">Amount</div></center></th>
								...
								<th><center><div style="width: 100px;">Check</div></center></th>
							</tr>
						</thead>
						<tbody></tbody>
					</table>
