...
<div class="content-wrapper">
	...
	<div class="row">
		...
		<div class="col-md-12 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title"><i class="mdi mdi-plus"></i>&nbsp;&nbsp;Add Header Numbering Sequence - <?php echo $result_file_name[0]->module_name; ?></h4>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="string_format_header" placeholder="Module ID">
							</div>
						</div>
						<div class="col-md-1">
							<div class="form-group">
								<label>&nbsp;</label>
								<select class="form-control" id="cut_1_header" style="color:white;">
									<option value="/">/</option>
									<option value="-">-</option>
								</select>
							</div>
						...
						<div class="col-md-1">
							<div class="form-group">
								<label>&nbsp;</label>
								<select class="form-control" id="cut_2_header" style="color:white;">
									<option value="/">/</option>
									<option value="-">-</option>
								</select>
							</div>
						...
						<div class="col-md-2">
							<div class="form-group">
								...
								<input type="number" class="form-control" id="number_length_header" value="4" min="4" placeholder="Module ID">
							</div>
						</div>
						<div class="col-md-2" style="padding-top:27px;">
							<button class="btn btn-primary me-2" onclick="add_header_numbering();"><i class="mdi mdi-content-save"></i>&nbsp;&nbsp;Save</button>
						</div>
					</div>

					<hr style="border:2px solid white;">

					<h4 class="card-title" style="padding-top:50px;"><i class="mdi mdi-plus"></i>&nbsp;&nbsp;Add Journal Numbering Sequence - <?php echo $result_file_name[0]->module_name; ?></h4>
					...
					<div class="row">
						...
						<div class="col-md-2">
							<div class="form-group">
								...
								<input type="text" class="form-control" placeholder="IDR" readonly>
							</div>
						</div>
						<div class="col-md-1">
							<div class="form-group">
						...
						<div class="col-md-1">
							<div class="form-group">
								<label>Month</label>
								<input type="text" class="form-control" style="color:black;" id="month" value="<?php echo $month_roman; ?>" readonly>
							</div>
						</div>
						<div class="col-md-1">
							<div class="form-group">
								<label>&nbsp;</label>
								<select class="form-control" id="cut_3" style="color:white;">
									<option value="/">/</option>
									<option value="-">-</option>
								</select>
							</div>
