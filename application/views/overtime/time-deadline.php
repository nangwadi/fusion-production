	...
	<div class="page-header">
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">create new time deadline</li>
			</ol>
		</nav>
	</div>
	<div class="row">
		...
		<div class="col-md-12 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title"><i class="mdi mdi-format-list-bulleted "></i>&nbsp;&nbsp;List Time Deadline</h4>
					<hr style="border:2px solid white;">

					<table class="table table-striped" id="list_time_deadline">
						<thead>
							<tr>
								<th style="color:white;">No</th>
								<th style="color:white;">Daily Maker</th>
								<th style="color:white;">Daily Approval</th>
								<th style="color:white;">Holiday Maker</th>
								<th style="color:white;">Holiday Approval</th>
								<th style="color:white;">Last By</th>
