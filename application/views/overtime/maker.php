...
<div class="content-wrapper">
	...
	<div class="row">
		<div class="col-md-4 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title"><i class="mdi mdi-plus"></i>&nbsp;&nbsp;Add Overtime Maker</h4>
					...
					<div class="form-group">
						...
						<select class="form-control" id="cIDDept" onchange="getDivision(0, 0, 0);" style="color:white;"></select>
					</div>
					<div class="form-group">
		...
		<div class="col-md-8 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title"><i class="mdi mdi-format-list-bulleted "></i>&nbsp;&nbsp;List Overtime Maker</h4>
					<hr style="border:2px solid white;">
					...
					<table class="table table-striped" id="list_maker_approval">
						<thead>
							<tr>
								...
								<th style="color:white;">Overtime Maker</th>
