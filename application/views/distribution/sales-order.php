...
<div class="content-wrapper">
				...
				<div class="card-body">
					<div class="row">
						...
						<div class="col-md-8">
							...
							<button class="btn btn-light" id="btn_approve" onclick="print_sales_order();" title="Print Sales Order <?php echo $result_file_name[0]->module_name; ?>"><i class="mdi mdi-printer"></i>&nbsp;&nbsp;Print</button>
							<button class="btn btn-info" onclick="list_sales_order_detail();" title="List <?php echo $result_file_name[0]->module_name; ?>"><i class="mdi mdi-format-list-bulleted"></i>&nbsp;&nbsp;List</button>
						</div>
					</div>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="row">
										...
										<div class="col-md-8">
											...
											<input type="hidden" class="form-control" id="sales_order_number_format" value="">
											<input type="text" class="form-control" id="sales_order_number" placeholder="Order Number" style="color:black; outline-color: 1px white solid;" readonly onclick="list_sales_order();">										
										</div>
									</div>
								</div>
								...
								<div class="col-md-12" style="padding-top:10px;">
									<div class="row">
										...
										<div class="col-md-8">
											<input type="date" class="form-control" id="sales_order_date" placeholder="Order Date" style="color:white;" value="<?php echo date('Y-m-d') ?>">
										</div>
									</div>
								</div>
								<div class="col-md-12" style="padding-top:10px;">
									<div class="row">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" id="quotation_number" placeholder="Quotation Number:" style="color:white;">								
										</div>
									</div>
								</div>
								<div class="col-md-12" style="padding-top:10px;">
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="row">
										...
										<div class="col-md-8">
											...
											<input type="text" class="form-control" id="account_name_project" placeholder="Project From" style="color:black;" readonly onclick="list_account('1');">
								...
								<div class="col-md-12" style="padding-top:10px;">
									<div class="row">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" id="customer_order_number" placeholder="Cust. Order Number" style="color:white;">	
										</div>
									</div>
								</div>
								<div class="col-md-12" style="padding-top:10px;">
									<div class="row">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" id="sales_order_owner" placeholder="Owner" style="color:black;" readonly value="<?php echo $cNmPegawai_session; ?>">
										</div>
									</div>
								</div>
								<div class="col-md-12" style="padding-top:10px;">
				...
				<div class="card-body">
					<div class="row">
						...
						<div class="col-md-8">
							...
							<button class="btn btn-warning" id="view_sales_receipt" onclick="view_sales_receipt();" title="View sales Receipt"><i class="mdi mdi-receipt"></i>&nbsp;&nbsp;View Receipt</button>&nbsp;&nbsp;
						</div>
					</div>
					<hr style="border:2px solid white;">
					...
					<table class="stripe row-border order-column" id="line_description">
						<thead>
							<tr style="background-color: rgba(129, 129, 129, 1); height:50px;">
								...
								<th style="background-color: rgba(129, 129, 129, 1) !important; z-index: 2;"><center><div style="width: 250px;">Job Name</div></th>
								<th style="background-color: rgba(129, 129, 129, 1) !important; z-index: 2;"><center><div style="width: 300px;">Line Description</div></th>
								<th><center><div style="width: 75px;">Qty Order</div></center></th>
								<th><center><div style="width: 75px;">Qty Shipt</div></center></th>
	...
	<div class="modal" tabindex="-1" role="dialog" id="modal_sales_receipt">
		<div class="modal-dialog modal-xl" role="document">
			<div class="modal-content">
				<div class="modal-header" style="background-color: white; color: black;">
					<h4 class="modal-title">List sales Receipt</h4>
				</div>
				<div class="modal-body" style="background-color: white; color: black;">
					<table class="table" id="list_sales_receipt">
						<thead>
							<tr>
								<th>sales Receipt</th>
								<th>Date</th>
				...
				<div class="modal-footer" style="background-color: white; color: black;">
			        <a class="btn btn-secondary" onClick="list_sales_receipt_close();">Close</a>
			    </div>
			</div>
		</div>
	</div>
