		...
		<div class="col-md-12 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					...
					<table class="stripe row-border order-column" id="list_sales_order">
						<thead>
							<tr style="background-color: rgba(129, 129, 129, 1); height:50px;">
								...
								<th style="background-color: rgba(129, 129, 129, 1) !important; z-index: 2;"><center><div style="width: 250px;">Customer Name</div></center></th>
								...
								<th><div style="width: 200px;" align="center">Approval</div></th>
							</tr>
						</thead>
						<!-- <tbody></tbody> -->
					</table>
