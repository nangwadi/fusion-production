	...
	<div class="page-header">
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">create new Approval Permission</li>
			</ol>
		</nav>
	</div>
	<div class="row">
		<div class="col-md-4 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title"><i class="mdi mdi-plus"></i>&nbsp;&nbsp;Add Approval Permission - <?php echo $result_file_name[0]->module_name; ?></h4>
					<hr style="border:2px solid white;">

					<div class="form-group">
						<label>Select Employee</label>
						<input type="hidden" class="form-control" id="id_approval_permission" value="">
					...
					<div class="col-md-12" style="padding-top:27px;">
						<button class="btn btn-primary me-2" onclick="add_approval_permission();"><i class="mdi mdi-content-save"></i>&nbsp;&nbsp;Save</button>
					</div>
		...
		<div class="col-md-8 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title"><i class="mdi mdi-format-list-bulleted "></i>&nbsp;&nbsp;List Approval Permission - <?php echo $result_file_name[0]->module_name; ?></h4>
					<hr style="border:2px solid white;">

					<table class="table table-striped" id="list_approval_permission">
						<thead>
							<tr>
	...
	<div class="modal" tabindex="-1" role="dialog" id="modal_disen">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body" style="background-color: white; color: black;">
					<input type="hidden" id="id_approval_permission_disen">
					<input type="hidden" id="value_disen">
					<p id="modal_body_disen"></p>
				</div>
				<div id="modal_footer_disen">
			        <a class="btn btn-primary" id="btn_disen" onClick="update_approval_permission();"></a>
