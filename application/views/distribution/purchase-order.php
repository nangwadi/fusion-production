				...
				<div class="card-body">
					<div class="row">
						...
						<div class="col-md-8">
							...
							<button class="btn btn-warning" id="btn_receipt" onclick="create_receipt();" title="Receipt <?php echo $result_file_name[0]->module_name; ?>"><i class="mdi mdi-receipt"></i>&nbsp;&nbsp;Receipt</button>&nbsp;&nbsp;
							...
							<div class="row">
								<div class="col-md-12">
									<div class="row">
										...
										<div class="col-md-8">
											<input type="hidden" class="form-control" id="id_account" placeholder="Vendor" style="color:black;">								
