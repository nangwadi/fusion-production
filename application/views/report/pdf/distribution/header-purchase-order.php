<?php
    ...
    $filename_qrcode = str_replace('/', 'XX', $purchase_order_number);
...
<table autosize="1" width="100%" style="overflow: wrap">
	<tr>
		...
		<td style="width:440px; vertical-align:top; padding-top: 50px;">
			<table>
				<tr>
					<td colspan="3"><div style="font-size:24px; font-weight:bold;">Purchase Order</div></td>
				</tr>
				<tr>
					<td style="width:150px; height: 50px; border: 1px solid black; vertical-align: top; font-size: 18px;">PO Date</td>
					<td style="width:150px; vertical-align: top;  top; font-size: 18px; border-top: 1px solid black; border-bottom: 1px solid black; border-right: 1px solid black; vertical-align: top;"><?php echo $purchase_order_date; ?></td>
				...
				<tr>
					<td style="width:150px; height: 50px; vertical-align: top; font-size: 18px; border-bottom: 1px solid black; border-right: 1px solid black; border-left: 1px solid black;">Order Number</td>
					<td style="width:150px; vertical-align: top;  top; font-size: 18px; border-bottom: 1px solid black; border-right: 1px solid black; vertical-align: top;"><?php echo $purchase_order_number; ?></td>
				</tr>
				<tr>
					<td style="width:150px; height: 50px; vertical-align: top; font-size: 18px; border-bottom: 1px solid black; border-right: 1px solid black; border-left: 1px solid black;">Expected Date</td>
					<td style="width:150px; vertical-align: top;  top; font-size: 18px; border-bottom: 1px solid black; border-right: 1px solid black; vertical-align: top;"><?php echo $purchase_order_date; ?></td>
				</tr>
				<tr>
					<td align="center" style="width:150px; height: 50px; vertical-align: top; font-size: 16px; border-bottom: 1px solid black; border-right: 1px solid black; border-left: 1px solid black;">Vendor Is Taxable<br>Yes</td>
					<td align="center" style="width:150px; vertical-align: top;  top; font-size: 16px; border-bottom: 1px solid black; border-right: 1px solid black; vertical-align: top;">Currency<br><?php echo $coa_currency_cd; ?></td>
					<td align="center" style="width:150px; height: 50px; vertical-align: top;  top; font-size: 16px; border-top: 1px solid black; border-bottom: 1px solid black; border-right: 1px solid black; vertical-align: top;">Rate<br><?php echo $rate_format; ?></td>
				</tr>
