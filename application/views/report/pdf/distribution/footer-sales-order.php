<table autosize="1" width="100%" style="overflow: wrap">
	<tr>
		<td style="width:650px; vertical-align:top;">
			...
			<table>
				<tr>
					<td style="font-size:20px; padding: 10px; width: 650px; height: 114px;  border: 1px solid black; vertical-align: top;">
						NOTE : <?php echo $note; ?>
					</td>
				</tr>
			</table>
		...
		<td style="width:400px; vertical-align:top;">
			...
			<table style="width:100%;" align="center">
				...
				<tr>
					<td style="font-size:20px; width:200px; vertical-align: top; " align="center" colspan="2">Bekasi, <?php echo $sales_order_date; ?></td>
				</tr>
				<tr>
