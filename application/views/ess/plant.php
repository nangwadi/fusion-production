	...
	<div class="page-header">
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">create new Plant</li>
			</ol>
		</nav>
	</div>
	<div class="row">
		<div class="col-md-4 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title"><i class="mdi mdi-plus"></i>&nbsp;&nbsp;Add Plant</h4>
					<hr style="border:2px solid white;">

					<div class="form-group">
						<label>Plant Name</label>
						<input type="hidden" class="form-control" id="id_plant">
					...
					<div class="form-group" align="right">
						<button class="btn btn-primary me-2" onclick="add_plant();"><i class="mdi mdi-content-save"></i>&nbsp;&nbsp;Save</button>
		...
		<div class="col-md-8 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title"><i class="mdi mdi-format-list-bulleted "></i>&nbsp;&nbsp;List Plant</h4>
					<hr style="border:2px solid white;">

					<table class="table table-striped" id="list_plant">
						<thead>
							<tr>
								<th style="color:white;">No</th>
								<th style="color:white;">Company Name</th>
								<th style="color:white;">Plant Name</th>
								<th style="color:white;">Plant Description</th>
	...
	<div class="modal" tabindex="-1" role="dialog" id="modal_disen">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body" style="background-color: white; color: black;">
					<input type="hidden" id="id_plant_disen">
					<input type="hidden" id="value_disen">
					<p id="modal_body_disen"></p>
				</div>
				<div id="modal_footer_disen">
			        <a class="btn btn-primary" id="btn_disen" onClick="update_plant();"></a>
