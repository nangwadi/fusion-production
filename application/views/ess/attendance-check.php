...
<div class="content-wrapper">
	...
	<div class="row">
					...
					<div class="row">
						<div class="col-md-3">
							<div class="form-group">
								...
								<select class="form-control" id="cIdPeriod" style="color:white;" onchange="list_daily_attendance();"></select>
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group" style="padding-top:25px;">
								...
								&nbsp;&nbsp; -->
								<button class="btn btn-info me-2" onclick="location.reload();"><i class="mdi mdi-refresh"></i>&nbsp;&nbsp;Refresh</button>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-md-12 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title"><i class="mdi mdi-format-list-bulleted "></i>&nbsp;&nbsp;List of <?php echo $desc; ?></h4>
