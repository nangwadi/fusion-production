			...
			<div class="card">
				<div class="card-body">
					...
					<div class="form-group">
						<label>Salary Component Code</label>
						<input type="text" class="form-control" id="cIDKomponen" placeholder="Salary Component Code">
					</div>
					<div class="form-group">
						<label>Salary Component Name</label>
						<input type="text" class="form-control" id="cNmKomponen" placeholder="Salary Component Name">
					</div>
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<select class="form-control form-control-sm" id="trans_manual" style="color:white;"></select>
							</div>	
						</div>
					</div>
		...
		<div class="col-md-8 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					...
					<table class="table table-striped" id="list_salary_component">
						<thead>
							<tr>
								<th style="color:white;">No</th>
								<th style="color:white;">Salary Component Name</th>
								<th style="color:white;">Category</th>
								<th style="color:white;">Trans Manual</th>
	...
	<div class="modal" tabindex="-1" role="dialog" id="modal_disen">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body" style="background-color: white; color: black;">
					<input type="hidden" id="cIDKomponen_disen">
