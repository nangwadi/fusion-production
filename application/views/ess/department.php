...
<div class="content-wrapper">
	...
	<div class="row">
		<div class="col-md-4 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title"><i class="mdi mdi-plus"></i>&nbsp;&nbsp;Add Department</h4>
					<hr style="border:2px solid white;">

					<div class="form-group">
						<label>Department ID</label>
						<input type="text" class="form-control" id="cIDDept" placeholder="Department ID">
					</div>
					<div class="form-group">
						<label>Department Name</label>
						<input type="text" class="form-control" id="cNmDept" placeholder="Department Name">
					</div>
					<div class="form-group" align="right">
						<button class="btn btn-primary me-2" onclick="add_department();"><i class="mdi mdi-content-save"></i>&nbsp;&nbsp;Save</button>
		...
		<div class="col-md-8 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title"><i class="mdi mdi-format-list-bulleted "></i>&nbsp;&nbsp;List Department</h4>
					<hr style="border:2px solid white;">

					<table class="table table-striped" id="list_department">
						<thead>
							<tr>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div id="modal_footer_disen">
			        <a class="btn btn-primary" id="btn_disen" onClick="update_department();"></a>
